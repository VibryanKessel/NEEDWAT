...
const Register = () => {
  ...
  return (
    <View style={tw`bg-white h-full flex items-center justify-between`}>
      <View>
        <Image
          style={tw`h-30 w-30 mx-auto rounded-full border-black  mt-15 mb-2`}
      ...
      <View style={tw`flex flex-col justify-between items-center `}>
        <View
          style={tw`flex flex-row flex-nowrap border-b-2 my-1 border-gray-200 pb-1 w-80`}
        >
        ...
        <Pressable
          style={tw`mx-auto bg-blue-600 rounded-3 w-80 py-3  mt-7`}
          onPress={getRest}
        >
      ...
      <View style={tw`pb-8`}>
        <Text style={tw`text-center text-gray-400 text-xs pb-3`}>
          Or register with..
        </Text>
        <View
          style={tw`flex flex-row flew-nowrap justify-between items-center w-50`}
        >
